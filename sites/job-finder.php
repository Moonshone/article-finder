      ...
      <div class="job-controls">
        ...
        <section id="criteriaPanel" class="job-panel is-locked" aria-labelledby="criteria-heading" aria-disabled="true"><div class="card-heading"><span class="step">02</span><div><h2 id="criteria-heading">Was suchst du?</h2><p>Lege deine wichtigsten Kriterien fest.</p></div></div>
          <form id="jobSearchForm" novalidate><fieldset id="criteriaFields" disabled>
            <fieldset class="choice-field"><legend>Suchmodus</legend><div class="choice-row"><label><input type="radio" name="suchmodus" value="mehrere_berufsbereiche" checked><span>Berufsbereiche</span></label><label><input type="radio" name="suchmodus" value="bestimmter_job"><span>Bestimmter Job</span></label></div></fieldset>
            <fieldset class="choice-field"><legend>Berufsbereiche</legend><div class="source-grid"><label><input type="checkbox" name="berufsbereiche" value="Content Creator" checked> Content Creator</label><label><input type="checkbox" name="berufsbereiche" value="Scrum Master" checked> Scrum Master</label><label><input type="checkbox" name="berufsbereiche" value="Projektmanagement" checked> Projektmanagement</label></div></fieldset>
            <div class="field"><label for="job">Job / Tätigkeit *</label><input id="job" name="job" type="text" maxlength="120" placeholder="AI Content Creator" autocomplete="organization-title" required><span id="jobError" class="field-error"></span></div>
