...
<html lang="de"><head>
  ...
  <header class="site-header"><nav class="main-nav" aria-label="Hauptnavigation"><a class="nav-link" href="/">Home</a><a class="nav-link" href="kunst.html">Kunst</a><a class="nav-link active" href="ai-me.html">AI &amp; Me</a><a class="nav-link" href="/stories/">Stories</a></nav></header>
      ...
      <div class="job-controls">
        ...
        <section id="criteriaPanel" class="job-panel is-locked" aria-labelledby="criteria-heading" aria-disabled="true"><div class="card-heading"><span class="step">02</span><div><h2 id="criteria-heading">Was suchst du?</h2><p>Lege deine wichtigsten Kriterien fest.</p></div></div>
          <form id="jobSearchForm" novalidate><fieldset id="criteriaFields" disabled>
            <div class="field"><label for="jobs">Job / Tätigkeit(en) *</label><textarea id="jobs" name="jobs_eingabe" rows="4" placeholder="z. B. Busfahrer, Berufskraftfahrer, Auslieferungsfahrer" aria-describedby="jobsHint jobsError" required></textarea><span id="jobsHint" class="field-hint">Einen oder mehrere Berufe eingeben. Mehrere Berufe mit Komma oder Zeilenumbruch trennen.</span><span id="jobsError" class="field-error"></span></div>
